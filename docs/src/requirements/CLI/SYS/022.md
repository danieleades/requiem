...
- uuid: 4bfeb7d5-d168-44a7-b0f1-e292c1c89b9a
  fingerprint: 343471bc66e06530434f3ad927232690
  hrid: CORE-USR-001
- uuid: 007f03ec-58ff-4cfb-b305-58fcf46be529
  fingerprint: 2e1622e86514112d28625aef37200ddc
  hrid: CORE-USR-006
---
# CLI-SYS-022 Create Requirement Command

## Statement

The tool shall provide a `req create` command that creates new requirement files with automatically assigned sequential IDs, optional template application, and support for inline content specification.
...
- Command renamed from `req add` to `req create` for clarity (alias maintained)
- Command syntax: `req create <KIND> [--parent HRID...] [--title TEXT] [--body TEXT]`
...
- Validates no HRID collisions before creating
...
- No UUID collisions
- No HRID collisions - attempting to create duplicate HRID fails with clear error
- Error messages identify conflicting UUIDs when duplicates detected
