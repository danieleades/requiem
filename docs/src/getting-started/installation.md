...
req create <TAB>             # Shows command-specific options and flags
```

The generated scripts complete subcommands, flags, and their fixed value sets. They do not complete requirement HRIDs, which are read from the repository at runtime.
