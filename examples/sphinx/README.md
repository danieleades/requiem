...
Requiem can be used alongside Sphinx. The only requirement is that files which are not requirements do not use filenames which have the same syntax as a Requiem human readable ID (HRID).
